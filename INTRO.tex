...
ao casar com o próprio filho, que, depois de matar seu pai, \\
casou-se com ela -- o que os deuses logo revelaram aos homens. \\
Enquanto ele reinava na amada Tebas sobre os cadmeus, \\
sofrendo dores por desígnios funestos dos deuses, \\
ela partiu para o Hades, forte guardião de suas portas, \\
após atar no teto elevado um laço pendente, \\
tomada por aflição, e a ele deixou muitas dores \\
por vir, as quais as Erínias da mãe vêm cumprir.
\end{verse}
\end{quote}
