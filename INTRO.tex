...
\textbf{PARA COMEÇAR: Forma e Conteúdo no \emph{Édipo Rei} de Sófocles.}
...
parecem estar entre os mais relevantes: desde Aristóteles (séc. IV a.
C.) esta tragédia de Sófocles (497/6 -- 406 a. C.) é considerada uma
...
na segunda metade do século V a. C (428 a. C.), também estavam cientes
...
épicos de Homero (séc. VIII a. C.), por exemplo, fazem referência a ele.
...
\emph{``Vi a mãe de Édipo, a bela Epicasta,}

\emph{que em ignorância um feito grave realizou}

\emph{ao casar com o próprio filho, que, depois de matar seu pai,}

\emph{casou-se com ela -- o que os deuses logo revelaram aos homens.}

\emph{Enquanto ele reinava na amada Tebas sobre os cadmeus,}

\emph{sofrendo dores por desígnios funestos dos deuses, }

\emph{ela partiu para o Hades, forte guardião de suas portas,}

\emph{após atar no teto elevado um laço pendente,}

\emph{tomada por aflição, e a ele deixou muitas dores}

\emph{por vir, as quais as Erínias da mãe vêm cumprir.'' }
...
Eurípides (480/79 -- 407/6), representado por volta de doze anos mais
...
\emph{A forma da tragédia: poesia dramática }

Deve-se primeiramente apontar para uma característica das tragédias
gregas que até o século XVIII era óbvia ao público teatral, mas que a
...
\emph{Construção do enredo e ironia trágica}

Mas juntamente com o trabalho poético da linguagem, o gênero trágico
...
sobre a cidade. É só nesse momento que a tragédia de Sófocles se inicia.
(Ver também no \emph{Apêndice} um resumo mais detalhado do drama
conforme suas subdivisões).
...
(i) o que se convencionou chamar de ``ironia dramática'' ou ``ironia
trágica'', e (ii) a maneira como Édipo efetua (ou como Sófocles faz que
...
(i) Diferente da figura da ironia propriamente dita, por meio da qual
...
da matança, o qual afirmou ter Laio e todos os demais sido mortos por
...
(ii) Na segunda parte do \emph{Édipo Rei}, o conhecimento enquanto
...
um senhor e sua comitiva de quatro homens. De imediato, o heroi passa
ter fortes suspeitas sobre si mesmo, mas ainda é preciso confirmar sua
...
Édipo deveria assumir o trono de Corinto, o heroi conta o motivo por que
deixara aquela cidade: segundo o oráculo de Delfos, ele mataria o pai e
dormiria com mãe. Mesmo estando livre de cometer o primeiro crime, Édipo
...
reviravolta da ação, através da qual o heroi deixa de aparecer como um
...
\emph{Aristóteles e a excelência dramática do} Édipo Rei
...
conhecimento'' (1452 a28-30) e a ``peripécia'' (\emph{peripéteia}), que
é ``a mudança para a direção oposta dos eventos'' (1452 a24-25). Pois
...
ocorre juntamente com a peripécia'' (1452 a31-33) ou, nos termos que
...
quando a surpresa resulta de modo natural'' (1455 a16-17) e não de
...
ouvir o enredo do Édipo'' (1453 b3-7). Como se vê, os três argumentos
...
passos do texto compostos pelo que se costuma classificar de versos
