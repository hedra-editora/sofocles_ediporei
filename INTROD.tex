...
parecem estar entre os mais relevantes: desde Aristóteles (século~\versal{IV} a.C.) 
...
na segunda metade do século~\versal{V} a.C (por volta de 428 a.C.), também estavam cientes
dos seus pontos mais importantes. O mito de Édipo, como muitos
...
épicos de Homero (século~\versal{VIII} a.C.), por exemplo, fazem referência a ele.
...
\emph{Édipo Rei} de Sófocles. É de se notar ainda que, como se infere de uma 
passagem de \emph{Os Sete contra Tebas}, mais um elemento
...
tarde e do qual nos restam apenas fragmentos, e testemunhos de ao menos
...
específicos de sua construção que se destacam por sua relevância. São eles: 
...
no drama e as palavras que a acompanham, que por sua vez podem ser
...
deles se dá quando Édipo assevera que pronunciará seu discurso como alguém
...
família real. O segundo momento se dá quando ele diz que travará essa
...
estrangeiro que é o homem mais virtuoso de Tebas e revela-se como seu
...
A excelência dramatúrgica de Sófocles no \emph{Édipo Rei} relaciona-se,
...
tragédia latina, o \emph{Édipo} de Sêneca (século~\versal{I} d.C.)
...
teatro clássico francês do século~\versal{XVII}. Assim, o Coro é omitido, e um
...
Já na primeira metade do século~\versal{XX}, André Gide escreve, em 1932,
...
A partir da segunda metade do século~\versal{XX} montagens teatrais memoráveis do
\emph{Édipo} tornam-se mais raras. Uma representação do mito fora dos
palcos que merece menção é o \emph{Édipo Rei}
de Pasolini, filmado em 1967 na árida paisagem do norte da
África -- um clássico do cinema, que pôs em cena um Édipo mais sensível
do que cerebral.
