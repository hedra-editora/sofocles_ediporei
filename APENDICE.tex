...
quem não o decifrasse. A pergunta era a seguinte\quad ``Qual o animal que de
...
de membros?''. Resposta\quad O ser humano.
...
--- Prólogo\quad ``a parte inteira da tragédia antes da entrada do
Coro'', isto é, antes do párodo propriamente dito.

--- Párodo\quad ``a primeira expressão do Coro completo'', o que
significa a primeira canção na peça.

--- Episódio\quad ``uma parte inteira da tragédia entre cantos corais
completos''; podendo, portanto, estar entre o párodo e o primeiro
estásimo, ou entre um estásimo e outro.

--- Estásimo\quad ``uma canção coral sem anapestos e troqueus'', ou
...
--- Êxodo\quad ``a parte inteira da tragédia depois da qual não há
canção do Coro'', o que quer dizer que se trata da parte final do drama,
após o último estásimo.

--- \emph{Kommós}\quad ``um lamento em que tomam parte o Coro e a
...
peças é previsível\quad os dois primeiros no início delas, e o último no
...
\begin{tabular}[c]{|p{4,2cm}|p{4,2cm}|}
   ...
   \textbf{Continuação do \emph{Êxodo,} 13691530.}          & \textbf{Édipo e Creonte}. Recitação no mesmo metro do prólogo e dos episódios anteriores até o verso 1515.\footnote{A partir desse ponto até o fim da peça, é empregado outro metro, mais raro à época de Sófocles\quad o tetrâmetro trocaico.} \\ \hline
   \end{tabular}
...
conteúdo dramático de cada uma delas\quad
...
Édipo conta a Jocasta toda sua história\quad a suspeita em Corinto quanto a
...
Corinto. Quem era esse outro pastor? O mensageiro responde\quad ``Era um dos
da casa de Laio''. E o Coro completa\quad ``Não é outro senão aquele que já
...
trazido. O mensageiro de Corinto diz\quad ``Aí está o homem que me deu a
criança''. Ponto por ponto, toda a verdade é extraída do pastor\quad ``O
...
últimas palavras\quad ``Nenhum mortal deve ser chamado feliz antes que
